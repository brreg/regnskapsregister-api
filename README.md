...
* Test environment: ST
* Pre-prod environment: PPE
The application is not deployed to a production environment, as it is currently made available as a "preview", with no guarantees of quality of service.
## ST test environment

[RREG-API Openshift deployment details](https://console-openshift-console.apps.ocp-st.regsys.brreg.no/k8s/cluster/projects/regnskap) (available only on Brønnøysundregistrene's internal network)
