...
data class RegnskapXmlHead (
    @JacksonXmlProperty(localName = "orgnr") val orgnr: String,
    @JacksonXmlProperty(localName = "regnskapstype") val regnskapstype: String,
    @JacksonXmlProperty(localName = "regnaar") val regnaar: Int,
    @JacksonXmlProperty(localName = "oppstillingsplan_versjonsnr") val oppstillingsplanVersjonsnr: String,
    @JacksonXmlProperty(localName = "valutakode") val valutakode: String,
    @JacksonXmlProperty(localName = "regnskap_dokumenttype") val regnskapDokumenttype: String? = null,
    @JacksonXmlProperty(localName = "startdato") val startdato: String,
    @JacksonXmlProperty(localName = "avslutningsdato") val avslutningsdato: String,
    @JacksonXmlProperty(localName = "mottakstype") val mottakstype: String,
    ...
    @JacksonXmlProperty(localName = "journalnr") val journalnr: String,
    @JacksonXmlProperty(localName = "mottatt_dato") val mottattDato: String,
    @JacksonXmlProperty(localName = "orgform") val orgform: String,
    ...
    @JacksonXmlProperty(localName = "aarsregnskapstype") val aarsregnskapstype: String,
