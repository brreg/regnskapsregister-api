...
object BR {
    ...
    val sumVarer = model.createProperty(uri, "sumVarer")
    val sumFordringer = model.createProperty(uri, "sumFordringer")
    val sumInvesteringer = model.createProperty(uri, "sumInvesteringer")
    val sumBankinnskuddOgKontanter = model.createProperty(uri, "sumBankinnskuddOgKontanter")
    ...
    val ordinaertResultatSkattekostnad = model.createProperty(uri, "ordinaertResultatSkattekostnad")
    val ekstraordinaerePoster = model.createProperty(uri, "ekstraordinaerePoster")
    val skattekostnadEkstraordinaertResultat = model.createProperty(uri, "skattekostnadEkstraordinaertResultat")
